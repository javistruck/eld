document.addEventListener('DOMContentLoaded', () => {
    ...
    const addQuestion = (questionText = '') => {
        ...
        questionItem.innerHTML = `
            ...
            <button type="button" class="clone-question-btn">Clone</button>
    ...
    const generateFinalEvaluationHtml = (title, instructions, questions) => {
        ...
        const innerScriptLines = [
            ...
            '        ',
            '        alert(\'Evaluación guardada con éxito! Ahora puedes generar el JSON.\');',
            '    };',
            '',
            '    form.addEventListener(\'submit\', (event) => {',
            '        event.preventDefault();',
            ...
            '            return;',
            '        }',
            '        const jsonStr = JSON.stringify(evaluationData, null, 2);',
            ...
            '        const filename = (evaluationData.idMatricula || \'sin_matricula\') + \'_\' + yyyy + \'-\' + mm + \'-\' + dd + \'_\' + hh + \'-\' + min + \'.json\';',
            '        ',
            '        a.href = url;',
            '        a.download = filename;',
            ...
            '                    listItem.textContent = \'Alumno: \' + eval.studentName + \' (Matrícula: \' + eval.idMatricula + \')\';',
            ...
            '                            "Matrícula: " + eval.idMatricula + "\\n" +',
            '                            "Instructor: " + eval.instructorName + "\\n" +',
            '                            "Aptitud del Día: " + eval.studentAptitude + "\\n" +',
            '                            "\\n--- Preguntas Evaluadas ---\\n" +',
            '                            questionsHtml',
            '                        );',
            '                    };',
